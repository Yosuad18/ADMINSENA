...
export default function ApprenticesCreate() {
    ...
    useEffect(() => {
        coursesService.list().then(r => setCourses(r.data)).catch(() => {});
        computersService.list().then(r => setComputers(r.data)).catch(() => {});
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await apprenticesService.create(form);
        ...
        <div className="flex justify-center">
            <div className="w-full max-w-2xl">
                <div className="bg-white rounded-xl shadow-sm p-6 border-t-4 border-sena-green">
                    <h3 className="text-lg font-bold text-sena-dark mb-4"><i className="fas fa-user-plus text-sena-green mr-2"></i>Registrar Aprendiz</h3>
